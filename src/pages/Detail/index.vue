        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleInfo in spuSaleAttrList" :key="saleInfo.id">
                ...
                <dd
                  ...
                  :key="saleValue.id"
                  @click="changeSale(saleValue, saleInfo.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 在这里加入购物车,进行路由跳转之前,发请求前把你购买的的产品信息通过请求的形式发送给服务器 -->
                <!-- 服务器进行相应的储存 -->
...
export default {
  ...
  methods: {
    //第一个参数是所对应的信息 第二个参数是所有的信息
    //产品的售卖属性切换高亮  排他思想
    changeSale(saleValue, arr) {
      //遍历全部售卖属性
      arr.forEach((item) => {
        //让所有已经选中的全部清空
        item.isChecked = 0;
    ...
    async addCart() {
      ...
      try {
        ...
        //一些简单的数据skuMum,通过query形式给路由组件传递过去
        //产品信息的数据[比较复杂:skuInfo],通过会话存储(不持久化,回花结束数据在消失)
        this.$router.push({
          name: 'addCartSuccess',
